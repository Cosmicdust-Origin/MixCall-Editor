...
export default async function HomePage({
  ...
  <span className="text-sm font-normal text-gray-400 ml-2">{sheets.length}개</span>
          ...
          {sheets.length === 0 ? (
            <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-8 text-center">
              ...
              <p className="text-gray-400 text-sm">아직 등록된 등록된 콜/믹스 표가 없어요</p>
              <p className="text-gray-300 text-xs mt-1">첫 번째 콜/믹스 표를 만들어보세요!</p>
              <Link href="/editor"
  ...
  <span className="text-gray-300 text-sm">→</span>
        ...
        <div className="bg-red-50 border border-red-100 rounded-xl p-5 text-center mb-6">
          <p className="text-gray-600 text-sm mb-3">직접 콜/믹스 표를 만들고 싶다면?</p>
          <Link href="/editor"
